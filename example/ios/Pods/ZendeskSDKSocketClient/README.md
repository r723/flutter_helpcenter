...
# ZendeskSDKSocketClient for iOS

The ZendeskSDKSocketClient library is used to provide a simple API to interact with web sockets in iOS projects.
...
By downloading or using the Zendesk ZendeskSDKSocketClient SDK, You agree to the Zendesk Master
...
If You make any Contributions (defined below) to the ZendeskSDKSocketClient SDK, 
